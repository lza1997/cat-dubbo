...
//	private static final String CONF_FILENAME = "src/main/resources/fdfs/fdfs_client.conf";
    ...
    private static final String CONF_FILENAME = Thread.currentThread().getContextClassLoader().getResource("").getPath() +"fastdfs/dfs-dev.properties";
