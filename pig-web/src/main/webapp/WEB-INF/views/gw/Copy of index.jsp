...
<head>
    ...
    <meta name="copyright" content="Copyright zsCat.com 版权所有" />
    <link href="${ctxPath!}/static/gw/Content/bootstrap.min.css" rel="stylesheet" />
   
    <link href="${ctxPath!}/static/gw/Content/index.min.css" rel="stylesheet" />
    <!--[if lt IE 9]>
    <script src="${ctxPath!}/static/gw/Scripts/html5shiv.min.js"></script>
    <![endif]-->
    <script src="${ctxPath!}/static/gw/Scripts/jquery.min.js"></script>
    <script src="${ctxPath!}/static/gw/Scripts/index.min.js"></script>
</head>

<body>
    <header>
        <div class="logo">
          <img src="${ctxPath!}/static/gw/Picture/logo.png" alt="我的网站" class="img-responsive" />
        </div>
        <strong class="words">专注高端网站建设</strong>
        <nav class="menu">
          <ul class="list-inline">
            <li class="active"><a>首页</a></li>
            @for(navList in page.list){
            <li><a>业务</a></li>
            <li><a>案例</a></li>
            <li><a>客户</a></li>
            <li><a>品质</a></li>
        ...
        <div class="hotline">
          <a href="tel:37-11111" title="网站建设免费咨询热线"><span>37-11111</span></a><u></u>
        </div>
        <div class="menu-icon">
  			<a href="tel:37-11111" title="点击直拨网站建设热线"><span class="glyphicon glyphicon-earphone"></span></a>
    ...
    <section class="video">
        ...
        <div class="innerBox">
        	<div class="news">
            	<span>NEWS :</span>
                <a href="${ctxPath!}/static/gw/a/news/" title="更多文章动态" class="more" target="_blank">more</a>
                <ul>
                   <li><a href="${ctxPath!}/info.jsp" target="_blank" title="2015羊年大吉，zsCat无忧网全体员工给新老">2015羊年大吉，zsCat无忧网全体员工给新老...</a></li>
<li><a href="${ctxPath!}/static/gw/a/news/industry/2015/0429/35.html" target="_blank" title="国家发改委推行电子政务，微信微博上线">国家发改委推行电子政务，微信微博上线...</a></li>
<li><a href="${ctxPath!}/static/gw/a/news/experience/2015/0429/51.html" target="_blank" title="钱都砸去哪里了，为什么你的网站推广没">钱都砸去哪里了，为什么你的网站推广没...</a></li>
<li><a href="${ctxPath!}/static/gw/a/news/experience/2015/0429/50.html" target="_blank" title="不是“PC端 + 移动端”的网站就叫响应式">不是“PC端 + 移动端”的网站就叫响应式...</a></li>
<li><a href="${ctxPath!}/static/gw/a/news/experience/2015/0429/49.html" target="_blank" title="黄色系网页配色分析与案例分享">黄色系网页配色分析与案例分享...</a></li>
        ...
        <div class="swiper-container items">
           <div class="swiper-wrapper">
                 <div class="swiper-slide">
                    <a href="${ctxPath!}/static/gw/a/cases/other/2015/0429/23.jsp" target="_blank">
                    <img src="${ctx}/uploads/allimg/150429/1-1504291A0160-L.jpg" alt="万博法务网站建设项目" />
                    <p>网站设计<br /><strong>万博法务网站建设项目</strong><br />门户网站,红色</p></a>
                  </div>
<div class="swiper-slide">
                    <a href="${ctxPath!}/static/gw/a/cases/media/2015/0429/22.html" target="_blank">
                    <img src="${ctx}/uploads/allimg/150429/1-1504291649100-L.jpg" alt="中国影响力网站设计" />
                    <p>网站设计<br /><strong>中国影响力网站设计</strong><br />门户网站,蓝色,国有企业</p></a>
                  </div>
<div class="swiper-slide">
                    <a href="${ctxPath!}/static/gw/a/cases/farming/2015/0429/21.html" target="_blank">
                    <img src="${ctx}/uploads/allimg/150429/1-150429164J40-L.jpg" alt="北京粮食科技研究所网站" />
                    <p>网站设计<br /><strong>北京粮食科技研究所网站</strong><br />官方网站,企业网站,绿色</p></a>
                  </div>

           </div>
        </div>
        <a href="${ctxPath!}/static/gw/a/cases/" title="欣赏更多网站建设案例" class="more" target="_blank">MORE</a>
      </div>
    </section>
    ...
    <section class="quality">
      <div class="box">
        ...
        <a href="http://www.zsCat.com" class="lookall" target="_blank">你以为看到了网站的全部？</a>
      </div>
    </section>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide nth3">
                ...
                <ul>
                  ...
                  <li>2011年<u>-</u>成功注册 " zsCat " 商标，树立品牌</li>
    ...
    <section class="contact">
    	<div class="box">
        	<div class="above">
            	<div class="wechat"><img src="${ctxPath!}/static/gw/Picture/wechat_code.jpg" alt="扫描关注zsCat微信公众账号" /></div>
                <div class="left">
                	<a href="tel:37-11111" title="网站制作咨询热线" class="tel"></a>
                    <p>中国<u>·</u>山东<u></u>滕州碧水云天中央城<br />联系电话：37-11111<u>/</u>0632<br />地址：滕州市 龙泉街道 <br />邮编：274500<a href="${ctxPath!}/static/gw/a/job/" target="_blank" class="job">[ 工作机会 ]</a></p>
                </div>
                <div class="right">
                	Email：Service@zsCat.com<br />中文域名：zsCat.中国<u>/</u>zsCat.com<br />Copyright 2008-2015<u></u>zsCat论坛 版权所有<br />鲁ICP备 88888888 号<br />
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="dock">
        <ul class="icons">
        	<li class="up"><i></i></li>
            <li class="im">
            	<i></i><p>网站建设咨询<br />在线沟通，请点我<a href="http://wpa.qq.com/msgrd?v=3&uin=379144319&site=qq&menu=yes" target="_blank">在线咨询</a></p>
            </li>
            <li class="tel">
            	<i></i><p>建站咨询热线：<br />37-11111<br />售后电话：<br />37-11111</p>
            </li>
            <li class="wechat">
            	<i></i><p><img src="${ctxPath!}/static/gw/Picture/wechat_code.jpg" alt="扫描关注网站建设微信公众账号" /></p>
            </li>
