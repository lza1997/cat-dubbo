package com.zs.pig.common.spring.aspect;
...
import com.zs.pig.common.spring.annotation.Log;
import com.zs.pig.common.sys.model.SysLog;
import com.zs.pig.common.utils.IPUtils;
import com.zs.pig.web.sys.service.SysLogService;
...
public class SystemLogAspect {
	...
	@Pointcut("@annotation(com.zs.pig.common.spring.annotation.Log)")
	public void accessAspect() {
	}
	
	@Pointcut("execution(* com.zs.pig.web..*Service.*(..))")
