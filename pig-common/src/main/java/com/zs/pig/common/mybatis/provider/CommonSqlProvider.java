package com.zs.pig.common.mybatis.provider;
...
import com.zs.pig.common.mybatis.EntityHelper;
...
public class CommonSqlProvider extends BaseProvider{
	...
	public String findEntityListByDataScope(final Map<String, Object> params){
		...
		return new SQL(){{
            ...
            com.zs.pig.common.mybatis.EntityHelper.EntityTable entityTable = EntityHelper.getEntityTable(entityClass);
            SELECT(com.zs.pig.common.mybatis.EntityHelper.getAllColumns(entityClass));
